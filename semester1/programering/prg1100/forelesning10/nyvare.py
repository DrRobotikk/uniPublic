...
def lager_vare_objeckt():
    ...
    nyVare = vare.Vare(varenr, varenavn, pris, katnr, antall, hylle)
...
def setterInnVare():
    ...
    datanyVare = (nyVare.get_varenr(), nyVare.get_varenavn(), nyVare.get_pris(
    ), nyVare.get_katnr(), nyVare.get_antall(), nyVare.get_hylle())
