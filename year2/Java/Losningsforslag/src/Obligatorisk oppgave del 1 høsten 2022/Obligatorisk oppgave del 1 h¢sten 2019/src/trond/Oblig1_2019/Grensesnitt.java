...
public class Grensesnitt {
	...
	//Definerer en array med tekstene p� knappene i undermenyen for enkelt dikt:
	private final String[] ENKELTALTERNATIVER = {"Registrer ord", "Skriv dikt", "Tilbake"};
	//Definerer en array med tekstene p� knappene i undermenyen for avansert dikt:
	...
	//Det kan v�re lurt (men ikke n�dvendig) � definere valg som konstanter:
	private final int ENKELT = 0;
	private final int AVANSERT = 1;
	private final int AVSLUTT = 2;
	//S� opprettes et objekt av applikasjonsklassen Dikter, som skal administrere ord og lage dikt:
	Dikter dikter = new Dikter();
	
	//Metoden lesValg() skriver ut hovedmenyen og leser menyvalg:
	public int lesValg( ) {
		int valg = JOptionPane.showOptionDialog(null,"Gj�r et valg","Diktgenerator",JOptionPane.DEFAULT_OPTION,
	...
	public int lesEnkeltValg() {
		int valg = JOptionPane.showOptionDialog(null,"Gj�r et valg","Enkelt dikt",JOptionPane.DEFAULT_OPTION,
	...
	public int lesAvansertValg() {
		int valg = JOptionPane.showOptionDialog(null,"Gj�r et valg","Avansert dikt",JOptionPane.DEFAULT_OPTION,
				JOptionPane.PLAIN_MESSAGE,null,AVANSERTALTERNATIVER,AVANSERTALTERNATIVER[0]);
				return valg;
	}
	
	//Metoden regOrd() tilh�rer enkelt dikt-delen:
	public void regOrd() {
	...
	//Metoden regVerb() tilh�rer den avanserte dikt-delen:
	public void regVerb() {
	...
	//Metoden regSunstantiv() tilh�rer den avanserte dikt-delen:
	...
	//Metoden regAdjektiv() tilh�rer den avanserte dikt-delen:
	...
	//Metoden regAdverb() tilh�rer den avanserte dikt-delen:
	...
	//ved � kalle metoden lagAvansert(), for deretter
	//� skrive det ut:
	...
	//ved � kalle metoden lagDikt(), for deretter
	//� skrive det ut:
	public void lagDikt() {
